...
export const ui = {
	en: {
		...
		home: {
			...
			installIntro: "Synch is temporarily unavailable in the Community Plugins directory due to a directory listing issue. Install it with BRAT in the meantime.",
			installSteps: [
	...
	ko: {
		...
		home: {
			...
			installTitle: "설치 방법",
			installIntro: "현재 디렉터리 등록 문제로 Community Plugins에서 Synch를 설치할 수 없습니다. 그동안은 BRAT을 이용해 설치해 주세요.",
			installSteps: [
	...
	ja: {
		...
		home: {
			...
			installIntro: "現在、ディレクトリ登録の問題により、Community PluginsからSynchをインストールできません。当面の間はBRATを使用してインストールしてください。",
			installSteps: [
	...
	"zh-cn": {
		...
		home: {
			...
			installTitle: "如何安装",
			installIntro: "由于目录收录问题，目前无法从 Community Plugins 安装 Synch。请暂时通过 BRAT 安装。",
			installSteps: [
	...
	"zh-tw": {
		...
		home: {
			...
			installTitle: "如何安裝",
			installIntro: "由於目錄收錄問題，目前無法從 Community Plugins 安裝 Synch。請暫時透過 BRAT 安裝。",
			installSteps: [
